   ...
   <div class="container">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-6 content">
            <!-- "md-6" specifies that the column should occupy 6 units of the available grid space on medium-sized screens.
                The grid system typically has a total of 12 units, so a column with "md-6" will take up half of the available space 
                in the specified medium-sized screen. -->
            <span>about us</span>
